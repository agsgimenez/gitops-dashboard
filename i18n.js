window.I18N = {
  es: {
    ...
    env_vars_title: 'Variables · todos los scopes',
    env_scope_org: 'Org · {owner}',
    env_scope_repo: 'Repo · {repo}',
    env_scope_env_label: 'Env · {env}',
    env_scope_readonly: 'solo lectura',
    env_scope_403: '⚠ Sin acceso (PAT necesita scope admin:org)',
    env_scope_empty: 'Sin variables ni secrets a este nivel.',
    env_scope_overrides: 'sobreescribe {scopes}',
  ...
  en: {
    ...
    env_vars_title: 'Variables · all scopes',
    env_scope_org: 'Org · {owner}',
    env_scope_repo: 'Repo · {repo}',
    env_scope_env_label: 'Env · {env}',
    env_scope_readonly: 'read-only',
    env_scope_403: '⚠ No access (PAT needs admin:org scope)',
    env_scope_empty: 'No variables or secrets at this level.',
    env_scope_overrides: 'overrides {scopes}',
